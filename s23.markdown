...
<div style="border: 2px solid #e74c3c; padding: 10px; background-color: #f9ebdf;">
    <p style="font-size: 20px; font-weight: bold; color: #e74c3c;">Announcement:</p>
    <p style="font-size: 16px; color: #333;">Sign up and learn more about the ZKP/Web3 Hackathon <a href="https://rdi.berkeley.edu/zkp-web3-hackathon/" style="color: #e74c3c; font-weight: bold;">here</a>!</p>
</div>
