...
<div style="border: 2px solid #4CAF50; padding: 10px; background-color: #E9F8E8;">
    ...
    <p style="font-size: 25px; color: #333;">Sign up and learn more about the ZKP/Web3 Hackathon <a href="https://zk-learning.org/zkp-web3-hackathon" style="color: #4CAF50; font-weight: bold;">here</a>!</p>
</div>
<br>
